...
const serviceFromAction = (action = '') => {
  ...
  if (value.includes('LOGIN') || value.includes('AUTH') || value.includes('SESSION') || value.includes('VAULT_')) return 'Auth';
