...
if exist "C:\Program Files\Java\jdk-21\bin\java.exe" set "JAVA_HOME=C:\Program Files\Java\jdk-21" & goto OkJHome
...
if not exist "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" (
    ...
    if "%WRAPPER_URL%"=="" (
        echo Cannot determine maven-wrapper.jar download URL >&2
        echo Please set wrapperUrl in .mvn/wrapper/maven-wrapper.properties >&2
        goto error
    )
